...
/* 	Claim Denials controller 
	Group by Remark Codes (clusters), then by Insurance
	Sorted by most $ amount on top
*/

app.controller('DenialsListController', function($scope, contactResource, practiceResource, insuranceResource, remarkResource) {
